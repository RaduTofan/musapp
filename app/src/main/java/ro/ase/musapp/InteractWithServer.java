...
public class InteractWithServer extends AsyncTask<String, Void,String> {
    ...
    public InteractWithServer(Context ctx){
        context=ctx;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            if (httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                result+="OK";
                File f = new File("/data/data/ro.ase.musapp/files/songs.zip");
    ...
    protected void onPostExecute(String s) {
        ...
        if(result!=null) {
            Intent it = new Intent(context, ListViewWithResult.class);
            context.startActivity(it);
            FormularActivity.mainActivity.finish();
        }else{
